...
$_SESSION['WPOA']['PROVIDER'] = 'KPV';
define('HTTP_UTIL', get_option('wpoa_http_util'));
define('CLIENT_ENABLED', get_option('wpoa_kpv_api_enabled'));
define('CLIENT_ID', get_option('wpoa_kpv_api_id'));
define('CLIENT_SECRET', get_option('wpoa_kpv_api_secret'));
define('REDIRECT_URI', rtrim(site_url(), '/') . '/');
define('SCOPE', 'read'); // PROVIDER SPECIFIC: 'profile' is the minimum scope required to get the user's id from Google
define('URL_AUTH', "http://admin.kpv.local/oauth/authorize?");
define('URL_TOKEN', "http://admin.kpv.local/oauth/access_token?");
define('URL_USER', "http://admin.kpv.local/userself?");
...
//        var_dump($access_token.' '.$expires_in);die;
	// handle the result:
